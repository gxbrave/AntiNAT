...
- Create/own: `internal/controller/lifecycle/**`, `internal/controller/recovery/**`, `migrations/0008_lifecycle.sql`, `docs/recovery.md`
...
- P10 owns `migrations/0004_probe.sql`, `migrations/0005_probe_hardening.sql`, and
  `migrations/0006_r13_hardening.sql`; P12 owns `migrations/0007_traversal.sql`.
  Lifecycle schema work starts at `0008_lifecycle.sql`; do not rename, edit, or
  reuse prior migration numbers.
