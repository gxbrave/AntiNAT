...
// 0003_enrollment.sql (plan 08 owns it), 0004_probe.sql (plan 10 owns it);
// the installer may still read them as plain files.
package migrations

import "embed"

//go:embed 0001_core.sql 0002_control.sql 0003_enrollment.sql 0004_probe.sql
var FS embed.FS

// Names is the ordered migration list; the index (1-based) is the schema
// version recorded in schema_migrations.
var Names = []string{"0001_core.sql", "0002_control.sql", "0003_enrollment.sql", "0004_probe.sql"}
