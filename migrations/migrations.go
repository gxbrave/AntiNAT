...
//go:embed 0001_core.sql 0002_control.sql 0003_enrollment.sql 0004_probe.sql 0005_probe_hardening.sql 0006_r13_hardening.sql 0007_traversal.sql
var FS embed.FS

// Names is the ordered migration list; the index (1-based) is the schema
// version recorded in schema_migrations.
var Names = []string{"0001_core.sql", "0002_control.sql", "0003_enrollment.sql", "0004_probe.sql", "0005_probe_hardening.sql", "0006_r13_hardening.sql", "0007_traversal.sql"}
