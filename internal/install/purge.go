...
func DefaultPurgeResources(layout Layout) []OwnedResource {
	resources := []OwnedResource{
		...
		{Root: layout.DataDir, Path: ".key.lock"},
		{Root: layout.DataDir, Path: ".lifecycle.lock"},
		{Root: layout.DataDir, Path: ".upgrade.lock"},
		{Root: layout.DataDir, Path: "controller.db"},
		{Root: layout.DataDir, Path: "controller.db-wal"},
		{Root: layout.DataDir, Path: "controller.db-shm"},
